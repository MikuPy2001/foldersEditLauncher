...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ImagePath.setGeometry(QtCore.QRect(330, 230, 200, 200))
        ...
        self.WIP.setGeometry(QtCore.QRect(330, 210, 191, 16))
        ...
        self.no_uss_label_6.setGeometry(QtCore.QRect(330, 190, 201, 16))
    ...
    def retranslateUi(self, Form):
        ...
        self.no_uss_label_10.setText(_translate("Form", "如果打开后没有目录,请检查"))
        self.no_uss_label_11.setText(_translate("Form", "1.是否放在游戏文件夹"))
        self.no_uss_label_12.setText(_translate("Form", "2.是否安装songCore插件"))
